<div class="box" data-tabcontent="z08">
	<div>
		<h5>Script code: <strong>z08</strong></h5>
		<hr>
		<ol>
			<li>
				...
				<div class="form-group">
					...
					<div class="d-flex justify-content-around w-25">
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z08-ack-yes" value="Yes">
							<label class="custom-control-label" for="z08-ack-yes">Yes</label>
						</div>
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z08-ack-no" value="No">
							<label class="custom-control-label" for="z08-ack-no">No</label>
						</div>
					</div>
				</div>
			</li>
		...
		<div class="d-flex justify-content-end">
			<span class="left-chevron" data-tab="z07">z07</span>
			<span class="mx-2">|</span>
			<span class="right-chevron" data-tab="z09">z09</span>
		</div>
	</div>
</div>