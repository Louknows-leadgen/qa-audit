<div class="box" data-tabcontent="z05">
	<div>
		<h5>Script code: <strong>z05</strong></h5>
		<hr>
		<ol>
			<li>
				...
				<div class="form-group">
					...
					<div class="d-flex justify-content-around w-25">
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z05-ack-yes" value="Yes">
							<label class="custom-control-label" for="z05-ack-yes">Yes</label>
						</div>
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z05-ack-no" value="No">
							<label class="custom-control-label" for="z05-ack-no">No</label>
						</div>
					</div>
				</div>
			</li>
		...
		<div class="d-flex justify-content-end">
			<span class="left-chevron" data-tab="z04">z04</span>
			<span class="mx-2">|</span>
			<span class="right-chevron" data-tab="z06">z06</span>
		</div>
	</div>
</div>