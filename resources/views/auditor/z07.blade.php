<div class="box" data-tabcontent="z07">
	<div>
		<h5>Script code: <strong>z07</strong></h5>
		<hr>
		<ol>
			<li>
				...
				<div class="form-group">
					...
					<div class="d-flex justify-content-around w-25">
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z07-ack-yes" value="Yes">
							<label class="custom-control-label" for="z07-ack-yes">Yes</label>
						</div>
						<div class="custom-control custom-radio">
							<input type="radio" class="custom-control-input" name="acknowledge" id="z07-ack-no" value="No">
							<label class="custom-control-label" for="z07-ack-no">No</label>
						</div>
					</div>
				</div>
			</li>
